...
Object.defineProperty(exports, "TestTemplateModule", {
    enumerable: true,
    get: function() {
...
const _testtemplatecontroller = require("./test-template.controller");
...
TestTemplateModule = _ts_decorate([
    (0, _common.Module)({
        imports: [
            _prismamodule.PrismaModule
        ],
        controllers: [
            _testtemplatecontroller.TestTemplateController
        ],
        providers: [
