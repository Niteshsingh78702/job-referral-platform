...
export declare class AdminController {
    ...
    updateInterviewStatus(interviewId: string, newStatus: string, reason: string, adminId: string): Promise<{
        success: boolean;
        message: string;
    }>;
    markInterviewCompleted(interviewId: string, notes: string, adminId: string): Promise<{
        success: boolean;
        message: string;
    }>;
    markInterviewNoShow(interviewId: string, noShowType: 'CANDIDATE' | 'HR', notes: string, adminId: string): Promise<{
        success: boolean;
        message: string;
    }>;
    ...
    updatePaymentStatus(paymentId: string, newStatus: PaymentStatus, reason: string, adminId: string): Promise<{
        success: boolean;
        message: string;
    }>;
    issueManualRefund(paymentId: string, reason: string, adminId: string): Promise<{
        success: boolean;
        message: string;
    }>;
